export class Equality {
    static getLine(lineNumber: number, symbol: string): string{
        ...
        switch(lineNumber){
            ...
            case 2: line = llll+llll+llll+llll+____; break;
            case 3: line = llll+llll+llll+llll+____; break;
            case 4: line = ____+____+____+____+____; break;
            case 5: line = ____+____+____+____+____; break;
            case 6: line = llll+llll+llll+llll+____; break;
            case 7: line = llll+llll+llll+llll+____; break;
